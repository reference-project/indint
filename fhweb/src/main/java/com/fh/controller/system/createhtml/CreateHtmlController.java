...
public class CreateHtmlController extends BaseController {
	...
	public Object proCode(HttpServletResponse response) throws Exception{
		...
		DelAllFile.delFolder(getFilePath()+"index.html"); //生成代码前,先清空之前生成的文件
		Freemarker.printFile("indexTemplate.ftl", root, "index.html", getFilePath(), getFtlPath());
	...
	public Object proAboutus(HttpServletResponse response) throws Exception{
		...
		Freemarker.printFile("aboutusTemplate.ftl", root, "webaboutus.html", getFilePath(), getFtlPath());
		map.put("result", "success");
		return AppUtil.returnObject(new PageData(), map);
	}
	...
	public Object proProduct(HttpServletResponse response) throws Exception{
		...
		Freemarker.printFile("productTemplate.ftl", root, "webproduct.html", getFilePath(), getFtlPath());
		map.put("result", "success");
		return AppUtil.returnObject(new PageData(), map);
	}
	...
	public Object proCooperation(HttpServletResponse response) throws Exception{
		...
		Freemarker.printFile("cooperationTemplate.ftl", root, "webcooperation.html", getFilePath(), getFtlPath());
		map.put("result", "success");
		return AppUtil.returnObject(new PageData(), map);
	}
	...
	public Object proNews(HttpServletResponse response) throws Exception{
		...
		Freemarker.printFile("newsTemplate.ftl", root, "webnews.html", getFilePath(), getFtlPath());
	...
	public void proNewsdetail() throws Exception{
		...
		Freemarker.printFile("newsdetailTemplate.ftl", root, "webnewsdetail.html", getFilePath(), getFtlPath());
	}
	...
	public Object proContactus(HttpServletResponse response) throws Exception{
		...
		Freemarker.printFile("contactusTemplate.ftl", root, "webcontactus.html", getFilePath(), getFtlPath());
		map.put("result", "success");
		return AppUtil.returnObject(new PageData(), map);
	}
